...
public class EditDistance {
   ...
   public static SubSln[][] align(String s1, String s2, HashMap<String, Integer> score, int penalty, int extension, boolean global) throws Exception {
