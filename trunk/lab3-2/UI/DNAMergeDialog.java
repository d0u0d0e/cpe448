...
public class DNAMergeDialog extends JDialog {
   /*
    * CONSTANTS
    */
   ...
   public DNAMergeDialog(Controller controller) {
      super();
   ...
   public DNAMergeDialog(Frame owner, Controller controller, String title) {
      super(owner, title);
